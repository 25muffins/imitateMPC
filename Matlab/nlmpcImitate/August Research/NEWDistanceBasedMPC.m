...
for ct = 1:500
    ...
    goal2 = [144*rand-72,...
             ...
             2*pi*rand-pi,...
             0,0,0];
    goal1(3) = wrapToPi(goal1(3));
    goal2(3) = wrapToPi(goal2(3));
    ...
    for k = 1:100
        ...
        %fprintf("k=%df switch=%d goal=[%.1f %.1f]\n", ...
        %k, goalswitch, currentGoal(1), currentGoal(2));
       %fprintf("step %d: dist1 = %.3f\n", k, dist1);
       %fprintf("step %d: dist2 = %.3f\n", k, dist2);
        %fprintf("x %d: y = %.3f\n", x(1), x(2));
        sp = repmat(currentGoal,N+1,1);
