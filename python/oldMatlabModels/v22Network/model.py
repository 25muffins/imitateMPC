...
def create_model():
    ...
    fc_2 = layers.Dense(300, name="fc_2_")(dropout)
    relu_2 = layers.ReLU()(fc_2)
    fc_3 = layers.Dense(200, name="fc_3_")(relu_2)
    relu_3 = layers.ReLU()(fc_3)
    fc_4 = layers.Dense(100, name="fc_4_")(relu_3)
    relu_4 = layers.ReLU()(fc_4)
    fc_5 = layers.Dense(45, name="fc_5_")(relu_4)
    relu_5 = layers.ReLU()(fc_5)
    fc_6 = layers.Dense(3, name="fc_6_")(relu_5)
    layer = layers.Activation('tanh')(fc_6)
