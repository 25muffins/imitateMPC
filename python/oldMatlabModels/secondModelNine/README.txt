...
--------------------------------------------
Layer "scaling": Layer class "nnet.cnn.layer.ScalingLayer" was exported 
...
* To load the model without weights:
    ...
    import secondModelNine
    model = secondModelNine.load_model(load_weights=False)
